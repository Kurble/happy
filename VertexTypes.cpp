...
namespace happy
{
	const D3D11_INPUT_ELEMENT_DESC VertexPosition::Elements[1] =
	{
	...
	const D3D11_INPUT_ELEMENT_DESC VertexPositionNormalTangentBinormalTexcoord::Elements[5] =
	{
		...
		{ "TANGENT",  1, DXGI_FORMAT_R32G32B32_FLOAT,    0, 40, D3D11_INPUT_PER_VERTEX_DATA, 0 },
	...
	const D3D11_INPUT_ELEMENT_DESC VertexPositionNormalTangentBinormalTexcoordIndicesWeights::Elements[7] =
	{
		...
		{ "TANGENT",  1, DXGI_FORMAT_R32G32B32_FLOAT,    0, 40, D3D11_INPUT_PER_VERTEX_DATA, 0 },
		{ "TEXCOORD", 0, DXGI_FORMAT_R32G32_FLOAT,       0, 52, D3D11_INPUT_PER_VERTEX_DATA, 0 },
		{ "TEXCOORD", 1, DXGI_FORMAT_R16G16B16A16_UINT,  0, 60, D3D11_INPUT_PER_VERTEX_DATA, 0 },
		{ "TEXCOORD", 2, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 68, D3D11_INPUT_PER_VERTEX_DATA, 0 },
	};
}